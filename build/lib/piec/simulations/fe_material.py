...
class Ferroelectric(Material):
    ...
    def apply_waveform(self, v, t):
        ...
        p_total = self.add_parasitic_effects(v, p_ideal)

        self.total_current = np.gradient(p_total, t)  # dP/dt gives current
   

    def get_voltage_response(self):
        return self.total_current*50, self.t #multiply current by 50 ohm to get voltage response,
